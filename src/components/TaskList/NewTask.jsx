...
const NewTask = ({ data }) => {
  return (
    <div
      className="flex-shrink-0 w-[300px] h-full bg-yellow-400 rounded-xl shadow-lg transition-transform duration-300 hover:scale-105"
    ...
    >
      ...
      >
        <button
          className="bg-orange-600 text-white py-2 px-4 rounded-lg hover:bg-orange-700 transition-all"
          style={{
            fontSize: "0.875rem",
            fontWeight: "600",
            padding: "0.5rem 1rem",
